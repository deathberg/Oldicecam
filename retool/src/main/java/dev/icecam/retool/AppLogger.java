...
public final class AppLogger {
    ...
    public AppLogger(Context ctx) {
        file = new File(ctx.getExternalFilesDir(null), "re-tool.log");
        log("logger", "file=" + file.getAbsolutePath());
    }

    public void setListener(Listener l) {
        listener = l;
        if (l != null) l.onLogChanged(buffer.toString());
    }
    ...
    public void log(String tag, String msg) {
        ...
        main.post(() -> {
            if (listener != null) listener.onLogChanged(buffer.toString());
        });
    }
